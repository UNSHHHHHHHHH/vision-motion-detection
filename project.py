import cv2
import time
from playsound import playsound  # Optional for sound alarm
import smtplib
...
# Initialize the webcam for video capturing (try CAP_DSHOW if MSMF has issues)
...
while True:
    ...
    # If frame is not grabbed, print an error message
    if not ret:
